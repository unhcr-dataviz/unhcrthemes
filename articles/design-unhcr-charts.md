...
Data visualization is a powerful tool for conveying information and
insights from complex datasets. The [United Nations High Commissioner
for Refugees](https://www.unhcr.org/) (UNHCR) provides crucial [refugee
statistics](https://www.unhcr.org/refugee-statistics/download/) that can
be presented in an informative and visually appealing manner. The
[unhcrthemes](https://github.com/vidonne/unhcrthemes) package, in
combination with the
[refugees](https://populationstatistics.github.io/refugees/) package and
the versatile [ggplot2](https://ggplot2.tidyverse.org) library, offers
an excellent solution to create UNHCR-branded charts with ease.

## Setup

Before we start creating UNHCR branded charts, make sure you have the
...
Some packages installed above will be loaded using the `::` notation to
make the code and intentions clearer.

For this tutorial, we’ll use statistics provided by UNHCR. The refugee
package allows us to access and work with this data. You can find more
information on the datasets available and the use of the
[refugees](https://populationstatistics.github.io/refugees/) package in
[this blog
post](https://www.unhcr.org/refugee-statistics/insights/explainers/refugees-r-package.html).
...
Let’s start by creating a simple bar chart to visualize the top 10
...
![](design-unhcr-charts_files/figure-html/bar-plot-1.png)
...
![](design-unhcr-charts_files/figure-html/bar-label-1.png)

### Grouped bar chart

Let’s compare the refugee population originating in each UNHCR region
for both 2012 and 2022. We will use a grouped bar chart.
...
![](design-unhcr-charts_files/figure-html/group-bar-plot-1.png)
...
![](design-unhcr-charts_files/figure-html/group-bar-label-1.png)

### Stacked bar chart

Let’s make a stacked bar chart comparing the top 10 countries of origin
for all people displaced across borders, by type, in 2022.
...
![](design-unhcr-charts_files/figure-html/stack-bar-plot-1.png)
...
![](design-unhcr-charts_files/figure-html/stack-bar-label-1.png)

### Population pyramid

This type of chart is perfect to represent age & gender disagregation.
Let’s make a population pyramid of populations protected and/or assisted
by UNHCR in 2022.
...
![](design-unhcr-charts_files/figure-html/pyramid-plot-1.png)

## Column chart

### Single column chart

A column chart is quite similar to a bar chart, but the bars are
...
![](design-unhcr-charts_files/figure-html/column-plot-1.png)
...
![](design-unhcr-charts_files/figure-html/column-label-1.png)

### Grouped column chart

Let’s compare the 2018-2022 refugee population, originating in the three
UNHCR regions in Africa. We will use a grouped column chart.
...
![](design-unhcr-charts_files/figure-html/group-col-plot-1.png)
...
![](design-unhcr-charts_files/figure-html/group-col-label-1.png)

### Stacked column chart

Let’s plot the forcibly displaced people by type of population from 2013
to 2022.
...
![](design-unhcr-charts_files/figure-html/stack-col-plot-1.png)
...
![](design-unhcr-charts_files/figure-html/stack-col-label-1.png)

### 100% stacked column chart

Let’s create a 100% stacked column chart showing the total refugee
...
![](design-unhcr-charts_files/figure-html/percent-stack-plot-1.png)
...
![](design-unhcr-charts_files/figure-html/percent-stack-label-1.png)

## Line chart

### Single line chart

Let’s plot the evolution of the total refugee population from 1993 to
2022.
...
![](design-unhcr-charts_files/figure-html/single-line-plot-1.png)

### Multiple line chart

Let’s plot the evolution of the total refugee and IDP population from
1993 to 2022.
...
![](design-unhcr-charts_files/figure-html/multi-line-plot-1.png)
...
![](design-unhcr-charts_files/figure-html/multi-line-label-1.png)
...
![](design-unhcr-charts_files/figure-html/area-plot-1.png)
...
![](design-unhcr-charts_files/figure-html/stack-area-plot-1.png)

## Pie chart

Let’s plot the percentage of women vs men for all population of concern
by the end of 2022.
...
![](design-unhcr-charts_files/figure-html/pie-plot-1.png)
...
![](design-unhcr-charts_files/figure-html/donut-plot-1.png)

## Less common charts

These less common type of charts can be created with the help of the
[ggplot2](https://ggplot2.tidyverse.org) and
[unhcrthemes](https://github.com/vidonne/unhcrthemes) packages but will
require extra packages. When needed, the code to install the extra
packages will be provided.

### Treemap

Let’s make a treemap of the refugee population by region of origin in
2022. For this we will use the
[`{treemapify}`](https://github.com/wilkox/treemapify) package.
...
![](design-unhcr-charts_files/figure-html/teeemap-plot-1.png)

### Slope

Let’s create a slope chart showing the evolution of the total refugee
...
![](design-unhcr-charts_files/figure-html/slope-plot-1.png)

We trust that this R package has equipped you with the tools needed to
craft visually appealing and on-brand charts with ease. Should you
...
our [UNHCR data visualization platform](https://dataviz.unhcr.org).
There, you will discover a multitude of [practical
examples](https://dataviz.unhcr.org/tools/r/) showcasing the package’s
capabilities in action. Furthermore, you can delve into our
comprehensive [data visualization
guidelines](https://dataviz.unhcr.org/general_guidance/), which offer
invaluable insights into UNHCR’s brand recommendations for charts,
ensuring that your visualizations harmonize perfectly with the
