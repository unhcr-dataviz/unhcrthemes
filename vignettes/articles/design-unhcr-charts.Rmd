...
Lst's make a treemap of the refugee population by region of origin in 2022. For this we will use the [`treemapify`](https://github.com/wilkox/treemapify) package.
