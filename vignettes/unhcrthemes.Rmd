...
For more information on each parameter and usage, visit the [function documentation page](https://vidonne.github.io/unhcrthemes/reference/index.html) and the [UNHCR Data Visualization Platform](https://dataviz.unhcr.org/tutorials/r/)
