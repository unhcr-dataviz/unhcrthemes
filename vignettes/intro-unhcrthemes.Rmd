...
```{r bar2, fig.width = 5.5, fig.height = 3.5}
df3 <- tribble(
...
```{r bar2_alt, fig.width = 5.5, fig.height = 3.5}
df3 |>
  pivot_longer(cols = -year) |>
  ggplot() +
...
```{r line, fig.width = 5.5, fig.height = 3.5}
df9 <- tribble(
~Year,~Refugees,~IDPs,
1990,17.4,0,
1991,16.85,0,
...
```{r area, fig.width = 5.5, fig.height = 3.5}
df10 <- tribble(
...
```{r line2, fig.width = 5.5, fig.height = 3.5}
df11 <- tribble(
