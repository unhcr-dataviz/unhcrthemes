...
unhcrcolors <- tibble::tibble(name = c("pal_unhcr",
                              ...
                              n5 = list(c(pal_main[3], pal_main[1:2], pal_main[5], pal_main[7]),
                                        ...
                                        c(pal_navy_unhcr[5], pal_navy_unhcr[3],
                                          pal_grey_unhcr[1],
                                          pal_red_unhcr[2], pal_red_unhcr[4])),
                              n6 = list(c(pal_main[3:4], pal_main[1:2], pal_main[5], pal_main[7]),
                              ...
                              n7 = list(c(pal_main[3:4], pal_main[1:2], pal_main[5:7]),
                              ...
                              n8 = list(c(pal_main[3:4], pal_main[1:2], pal_main[5:8]),
                              ...
                              n9 = list(c(pal_main[3:4], pal_main[1:2], pal_main[5:9]),
                                        pal_poc,
                                        NULL,
                                        NULL, NULL, NULL,
                                        NULL, NULL, NULL,
                              ...
                              n10 = list(c(pal_main[3:4], pal_main[1:2], pal_main[5:10]),
                                         NULL, NULL,
                                         NULL, NULL, NULL,
                                         NULL, NULL, NULL,
                                         NULL, NULL))
