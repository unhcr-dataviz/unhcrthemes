...
- A collection of color palettes that ensure your plots are consistent with [UNHCR's color scheme](https://dataviz.unhcr.org/general_guidance/).
...
```{r base-plot, message = FALSE, warning = FALSE, out.width="85%", fig.align="center"}
...
```{r palette-all, message = FALSE, warning = FALSE, out.width="85%", fig.align="center", fig.height=4.5}
# Display all unhcr color palette
display_unhcr_all()
```

```{r palette-blue, message = FALSE, warning = FALSE, out.width="85%", fig.align="center", fig.height=2.5}
...
```{r scale-plot, message = FALSE, warning = FALSE, out.width="85%", fig.align="center"}
...
```{r geom-plot, message = FALSE, warning = FALSE, out.width="85%", fig.align="center", fig.height=4}
...
- [Data Visualization Platform](https://dataviz.unhcr.org/): A collection of recommendations on [chart type](https://dataviz.unhcr.org/chart_gallery/) selection, [general dataviz design](https://dataviz.unhcr.org/general_guidance/), [tools and tutorials](https://dataviz.unhcr.org/tools/) and a showcase of some of the [data visualization products made by UNHCR](https://dataviz.unhcr.org/products/).

## Acknowledgements

We extend our gratitude to the creators of the [`{hrbrthemes}`](https://github.com/hrbrmstr/hrbrthemes) and [`{cowplot}`](https://github.com/wilkelab/cowplot/) packages that influenced the development of `{unhcrthemes}`.
