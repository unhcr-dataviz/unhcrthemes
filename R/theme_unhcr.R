#' UNHCR [ggplot2] theme following brand recommandations
#'
...
theme_unhcr <- function(base_family="Lato",
  ...
  ret <- ret + ggplot2::theme(axis.text.x=ggplot2::element_text(size=base_size,
                                              color = dark_text))
  ret <- ret + ggplot2::theme(axis.text.y=ggplot2::element_text(size=base_size,
                                              color = dark_text))
  ret <- ret + ggplot2::theme(axis.title.y.right=ggplot2::element_text(hjust=1,
  ...
  ret <- ret + ggplot2::theme(plot.subtitle=ggplot2::element_text(hjust=0,
                                                ...
                                                color = dark_text))
  ret <- ret + ggplot2::theme(plot.caption=ggplot2::element_text(hjust=0,
  ...
  ret <- ret + ggplot2::theme(legend.title = ggplot2::element_text(hjust=0,
                                                 ...
                                                 color = dark_text))
  ret <- ret + ggplot2::theme(legend.text = ggplot2::element_text(hjust=0,
